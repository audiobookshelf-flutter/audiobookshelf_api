...
_$CollectionExpanded _$$CollectionExpandedFromJson(Map<String, dynamic> json) =>
    _$CollectionExpanded(
      id: json['id'] as String,
      libraryId: json['libraryId'] as String,
      userId: json['userId'] as String,
      name: json['name'] as String,
      ...
      books: (json['books'] as List<dynamic>)
          .map((e) =>
              BookLibraryItemExpanded.fromJson(e as Map<String, dynamic>))
          .toList(),
      lastUpdate:
          const DateTimeEpochConverter().fromJson(json['lastUpdate'] as int),
      createdAt:
...
Map<String, dynamic> _$$CollectionExpandedToJson(
        _$CollectionExpanded instance) =>
    <String, dynamic>{
      'id': instance.id,
      'libraryId': instance.libraryId,
      'userId': instance.userId,
